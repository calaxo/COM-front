  ...
  return (
    <div className="robot-page-container">
      <div className="robot-info">
        <h1>Robot detecteur et boucheur de fuite de gaz</h1>
        <p>
          detecte grace au son des fuite camera a son et reactif chimique
          applique une mouus colmateurse prouvé et breveté
        </p>
      </div>
