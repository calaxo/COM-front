...
function App() {
  ...
  const navigationLinks = [
    { to: "/Accueil", text: "Accueil",class: "btnheader",style: navigationLinkStylesBase },

    { to: "/Drone", text: "Drone", class: "btnheader",style: navigationLinkStylesBut },
    { to: "/Serpent", text: "Serpent", class: "btnheader",style: navigationLinkStylesBut },
        ...
        <div className="header-right">
          <div className="nav-links">
            ...
            {navigationLinks.map((link) => (
              <NavLink key={link.to} to={link.to} className={`${link.class} rounded-button nav-link`} style={link.style}>
                {link.text}
